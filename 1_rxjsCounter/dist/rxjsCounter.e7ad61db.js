...
},{"tslib":"../node_modules/tslib/tslib.es6.js","./isFunction":"../node_modules/rxjs/dist/esm5/internal/util/isFunction.js"}],"C:/Users/88698/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
var counter = 0; // 自訂subject來通知計數器改變
// 在命名上，我們習慣會在變數後面加上一個 $ ，代表它是一個可被觀察的 (observable) 物件。

var counter$; // 將「開始新的計數器」按鈕事件變成一個 observable，並透過訂閱 (subscribe)得知事件發生：

(0, rxjs_1.fromEvent)(startButton, 'click').subscribe(function () {
  // 重新建立 counter$ 實體
  counter$ = new rxjs_1.Subject(); // 將counter歸零

  counter = 0; // 顯示狀態

  statusLabel.innerHTML = "目前狀態:開始計數"; // 訂閱 counter$ 並顯示目前計數值
  ...
  var evenCounter$ = counter$.pipe((0, rxjs_1.filter)(function (data) {
    return data % 2 === 0;
...
},{"rxjs":"../node_modules/rxjs/dist/esm5/index.js"}],"C:/Users/88698/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/88698/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","rxjsCounter.ts"], null)
//# sourceMappingURL=/rxjsCounter.e7ad61db.js.map